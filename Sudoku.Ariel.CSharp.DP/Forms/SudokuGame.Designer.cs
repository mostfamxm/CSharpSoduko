...
namespace Sudoku.Ariel.CSharp.DP.Forms
{
    partial class SudokuGame
    {
        ...
        private void startGame()
        {
            ...
            this.m_CheckButton = (CheckCButtonLogic)new ButtonFactory().MakeButton("Ch");              
            // newCheckCButtonLogic(this.CheckButton, this.sudokuBlocks.Blocks);
            this.m_ClearButton = (ClearButton)new ButtonFactory().MakeButton("C");
